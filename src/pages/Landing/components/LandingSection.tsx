			...
			>
				...
				>
					...
					>
						<h1
							className={twJoin(
								"overflow-visible bg-gradient-to-br from-ga-white-default via-ga-white-default to-ga-orangenut-default bg-clip-text text-center text-3xl font-bold text-transparent md:text-5xl",
					...
					>
						<img
							...
							className={twJoin(
								...
								"w-2/3 rounded-3xl bg-gradient-to-t from-ga-blue/10 to-ga-orangenut-darker/10 p-2 opacity-10 sm:max-w-sm md:w-full md:p-16 md:opacity-100",
							)}
						/>
					</m.div>
